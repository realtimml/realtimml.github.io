...
function AboutPage() {
  return (
    <section className="relative min-h-dvh w-full overflow-hidden brightness-80">
      <div
        aria-hidden
        className="absolute inset-0 scale-110 bg-cover bg-position-[100%_30%] blur-2xl md:blur-md"
        style={{ backgroundImage: `url(${groundBg})` }}
      />
      <div className="relative z-10 min-h-dvh px-6 sm:px-12 xl:px-28 py-20 font-monospace text-[19px] md:text-2xl">
